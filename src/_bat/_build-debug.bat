...
C:\Python\python -m PyInstaller --add-binary *.dll;. --clean --exclude-module tkinter --exclude-module _asyncio --exclude-module _bz2 --exclude-module _decimal --exclude-module _elementtree --exclude-module _hashlib --exclude-module _lzma --exclude-module _multiprocessing --exclude-module _overlapped --exclude-module _queue --exclude-module _testcapi --debug=all --onedir --noupx --name "%AppName%" --version-file=version.txt --icon=main.ico main.py
